            ...
            <div class="col-xs-12 col-sm-4">
              <div class="box p-a">
                ...
                <div class="clear">
                  ...
                  <small class="text-muted">Promedio: 30 %</small>
                </div>
              </div>
            </div>
            <div class="col-xs-6 col-sm-4">
              <div class="box p-a">
                ...
                <div class="clear">
                  ...
                  <small class="text-muted">Temp Pico: 40 C</small>
                </div>
              </div>
            </div>
            <div class="col-xs-6 col-sm-4">
              <div class="box p-a">
                ...
                <div class="clear">
                  ...
                  <small class="text-muted">Indice Pico: 50% </small>
                </div>
              </div>
            </div>
          </div>
...
client.on('connect', () => {
    ...
    client.subscribe('values', { qos: 1 }, (error) => {
        if (!error) {
